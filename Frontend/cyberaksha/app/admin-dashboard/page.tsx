...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    // Frontend showcase mode - use demo data
    setStats({
      open_incidents: 24,
      total_reported: 156,
      resolved_today: 8,
    ...
    setIncidentData([
      ...
      { name: "Apr", incidents: 14 },
      { name: "May", incidents: 22 },
    ])
    setRiskData([
    ...
    setPriorityIncidents([
      { id: 1, title: "Potential Intrusion Attempt", severity: "Critical" },
      { id: 2, title: "Suspicious File Upload", severity: "High" },
      { id: 3, title: "Unauthorized Access Attempt", severity: "Critical" },
    ])
    setHeatmap([
      { day: "Mon", hour: "08:00", count: 5 },
      { day: "Tue", hour: "14:00", count: 12 },
      { day: "Wed", hour: "10:00", count: 8 },
    ])
  }, [])
